# tools for multiple comparisons correction
# code from mne tools
# copied from https://github.com/mne-tools/mne-python/blob/e4c995b4517089f7f105a9afb997f1b05a4e3653/mne/stats/multi_comp.py
